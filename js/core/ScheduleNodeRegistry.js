...
const definitions = {
  ...
  scheduleEnd: { label: "活动结束", flowInputs: [flowIn()] },
  ...
  insertSchedule: { label: "插入活动", flowInputs: [flowIn()], flowOutputs: [flowOut()], valueInputs: [input("scheduleId", VALUE, "string"), input("addTime", VALUE, "number"), input("queue", VALUE, "string"), input("respectPrerequisite", VALUE, "bool"), input("protectFromExpiry", VALUE, "bool")] },
  ...
  uiSetText: { label: "设置界面文字", flowInputs: [flowIn()], flowOutputs: [flowOut()], valueInputs: [input("widgetId", VALUE, "string"), input("value", VALUE, "string")] },
  uiSetValue: { label: "设置界面值", flowInputs: [flowIn()], flowOutputs: [flowOut()], valueInputs: [input("widgetId", VALUE, "string"), input("value")] },
  uiSetOptions: { label: "设置界面选项", flowInputs: [flowIn()], flowOutputs: [flowOut()], valueInputs: [input("widgetId", VALUE, "string"), input("options")] },
  hisRefresh: { label: "刷新 HIS 病人", flowInputs: [flowIn()], flowOutputs: [flowOut()], valueInputs: [input("query", VALUE, "string")] },
  hisSelectPatient: { label: "选择 HIS 病人", flowInputs: [flowIn()], flowOutputs: [flowOut()], valueInputs: [input("patientId", VALUE, "string")] },
  hisRenderDiagnosis: { label: "显示 HIS 诊断", flowInputs: [flowIn()], flowOutputs: [flowOut()] },
  hisRenderPrescription: { label: "显示 HIS 处方", flowInputs: [flowIn()], flowOutputs: [flowOut()] },
  hisSubmit: { label: "提交 HIS 诊疗", flowInputs: [flowIn()], flowOutputs: [flowOut()], valueInputs: [input("diagnosisId", VALUE, "string"), input("medicineIds")] },
  ...
  scheduleExpiry: { label: "活动过期", valueInputs: [input("expires", VALUE, "bool"), input("expiresAt", VALUE, "number")] },
  getInventory: { label: "背包取值", valueInputs: [input("itemId", VALUE, "string")], valueOutputs: [{ name: "value", kind: VALUE, type: "number" }] },

  getScheduleStatus: { label: "活动状态", valueInputs: [input("instanceId", VALUE, "string")], valueOutputs: [{ name: "value", kind: VALUE, type: "number" }] },
  getScheduleInstanceCount: { label: "活动实例数量", valueInputs: [input("scheduleId", VALUE, "string")], valueOutputs: [{ name: "value", kind: VALUE, type: "number" }] },
