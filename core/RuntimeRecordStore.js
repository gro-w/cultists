export class RuntimeRecordStore {
  ...
  define(definition) { if (!definition?.id) throw new Error("Runtime record definition requires id"); this.definitions.set(String(definition.id), structuredClone(definition)); return definition; }
