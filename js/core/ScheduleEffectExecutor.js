...
/** Domain-side operations used by ScheduleRunner, kept out of flow traversal. */
export class ScheduleEffectExecutor {
  ...
  insertSchedule(scheduleId, addTime, queue, options) {
    const result = scheduleData.addSchedule(scheduleId, addTime, queue, options);
...
export const scheduleEffectExecutor = new ScheduleEffectExecutor();
export default ScheduleEffectExecutor;
